...
>
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('automobiles.index')" :active="request()->routeIs('automobiles.*')">
                        {{ __('Automobiles') }}
                    </x-nav-link> 
                </div>
    ...
    <div class="hidden group-data-[responsive-nav-open-value=true]:block sm:group-data-[responsive-nav-open-value=true]:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('automobiles.index')" :active="request()->routeIs('automobiles.*')">
                {{ __('Automobiles') }}
            </x-responsive-nav-link> 
        </div>
    </div>
